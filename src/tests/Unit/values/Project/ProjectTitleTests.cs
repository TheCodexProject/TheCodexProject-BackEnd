...
{
    /// <summary>
    /// Test to check if ProjectTitle value object will let you create an empty title.
    /// </summary>
    [Fact]
    public void Title_Cannot_Be_Empty_Is_Failure()
    {
        ...
        // Act
        var result = ProjectTitle.Create(value);
    ...
    public void Title_Cannot_Be_Empty_Exception_Check()
    {
        ...
        //Assert
        Assert.True(result.IsFailure);
        Assert.Contains(result.Errors, e => e is ProjectTitleEmptyException);
    }
    ...
    public void Title_Cannot_Be_Less_Than_Three_Characters_Exception_Check()
    {
        ...
        // Assert
        Assert.True(result.IsFailure);
        Assert.Contains(result.Errors, e => e is ProjectTitleTooShortException);
    }
    ...
    public void Title_Cannot_Be_More_Than_75_Characters_Exception_Check()
    {
        ...
        // Assert
        Assert.True(result.IsFailure);
        Assert.Contains(result.Errors, e => e is ProjectTitleTooLongException);
    }
